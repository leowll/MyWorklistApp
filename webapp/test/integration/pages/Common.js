sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			...
			if (sHash) {
				sHash = "#ManageProducts-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#ManageProducts-display";
			}
		...
		return Opa5.extend("mycompany.myapp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["mycompany/myapp/localService/mockserver"], function (mockserver) {
